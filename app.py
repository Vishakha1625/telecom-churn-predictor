...
# ── Supplementary fixes: table color-scheme + sidebar toggle ──────────────────
st.markdown("""
<style>
/* ═══════════════════════════════════════════════════════════
   FIX 1 — DATAFRAME / TABLE (Chrome + Edge + Streamlit Cloud)
   The glide-data-grid canvas reads color-scheme to decide
   whether to render dark or light. Without this the canvas
   defaults to the OS/browser light theme → black text on
   a dark-CSS background → invisible data.
═══════════════════════════════════════════════════════════ */
html,
body,
.stApp {
...
/* Fallback for browsers that still render an HTML table */
...
/* ═══════════════════════════════════════════════════════════
   FIX 2 — SIDEBAR CONTENT VISIBLE (text/bg not washed out)
═══════════════════════════════════════════════════════════ */
[data-testid="stSidebar"] {
    background-color: #161B27 !important;
    border-right: 1px solid #2A3347 !important;
...
/* Force all sidebar text to stay light */
...
/* ═══════════════════════════════════════════════════════════
   FIX 3 — SIDEBAR <<< (collapse) AND >>> (expand) BUTTONS
   These live in the header bar. The header must not be
   zero-height or the button becomes invisible/unclickable.
═══════════════════════════════════════════════════════════ */

/* Keep the header bar at full height so its buttons show */
...
/* Catch-all — any button in the header area */
